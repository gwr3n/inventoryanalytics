...
class RQ_CPLEX(StochasticLotSizing):
    ...
    def __init__(self, K: float, h: float, p: float, d: List[float], std_d: List[float], I0: float = 0):
        ...
        self.N = 5 # 5 partitions, 6 segments
    ...
    def model(self):
        ...
        Ip = model.continuous_var_dict(idx, name="Ip") # I^+
        Im = model.continuous_var_dict(idx, name="Im") # I^-
    ...
    @staticmethod
    def _test():
        instance = {"K": 50, "h": 1, "p": 2, "d":[5,15,26,44,24,15,22,10], "std_d" : [1.5,4.5,7.8,13.2,7.2,4.5,6.6,3], "I0": 0}
